...
with st.sidebar:
    ...
    network = st.selectbox(
        "Select Network",
        ["mainnet", "testnet"],
        index=0 if st.session_state.network == "mainnet" else 1
    )
...
if st.session_state.current_step == 0:
    ...
    with col1:
        ...
        ip_type = st.selectbox("IP Type", [t.value for t in IPType])
...
with st.sidebar:
    ...
    status_items = [
        ("Wallet Connected", st.session_state.wallet_connected),
        ("Agent Configuration", st.session_state.agents_configured),
        ("IP Registration", st.session_state.ip_registered),
        ("License Creation", st.session_state.license_created),
        ("License Attachment", st.session_state.license_attached),
